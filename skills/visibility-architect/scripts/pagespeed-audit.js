...
https.get(apiUrl, (res) => {
  ...
  res.on('end', () => {
    try {
      ...
      const catScore = (id) => categories[id] && categories[id].score !== null ? Math.round(categories[id].score * 100) : null;
      ...
      const scores = [performanceScore, seoScore, a11yScore, bpScore].filter(s => s !== null);
...
const FIXES = {
  ...
  // Best practices
  'image-aspect-ratio': 'Set width/height attributes matching intrinsic ratio on <img>.',
